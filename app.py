        ...
        with st.form("pro_signup", clear_on_submit=False):
            ...
            if submitted:
                if not name or not email:
                    ...
                    # Save lead (in production, this would go to a CRM/email/Stripe)
...
def _save_lead(tier: str, name: str, email: str, company: str, details: str, mes: str, comments: str):
    """Save lead info. In production: CRM/email/webhook. For now: local file + email notification."""
    import json
    ...
    # Save locally (Streamlit Cloud has ephemeral storage, but this works for self-hosted)
